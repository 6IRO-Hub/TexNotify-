...
function TexNotify:Show(config)
    ...
    NotificationFrame.BackgroundColor3 = config.ColorNotify or Color3.fromRGB(35, 35, 45)
    ...
    Glow.ImageColor3 = config.ColorNotify or Color3.fromRGB(100, 100, 255)
    ...
    if config.Button3 then buttonCount = buttonCount + 1 end
    ...
    if config.Button3 then
        createButton(config.Button3, currentButton, "Button3")
    end
